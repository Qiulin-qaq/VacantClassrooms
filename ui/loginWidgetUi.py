...
"")
        ...
        self.btn_admin = QtWidgets.QPushButton(self.frame_login)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setUnderline(True)
        self.btn_admin.setFont(font)
        self.btn_admin.setObjectName("btn_admin")
        self.horizontalLayout_5.addWidget(self.btn_admin)
...
"}")
    ...
    def retranslateUi(self, Widget):
        ...
        Widget.setWindowTitle(_translate("Widget", "登录空教室查询系统"))
        self.label_login.setText(_translate("Widget", "BUPT"))
        self.btn_admin.setText(_translate("Widget", "Administrator login"))
