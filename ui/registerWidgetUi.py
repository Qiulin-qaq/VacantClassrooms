...
"")
        ...
        self.btn_register = QtWidgets.QPushButton(self.frame_login)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_register.sizePolicy().hasHeightForWidth())
        self.btn_register.setSizePolicy(sizePolicy)
        self.btn_register.setMinimumSize(QtCore.QSize(320, 50))
        self.btn_register.setMaximumSize(QtCore.QSize(320, 50))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        self.btn_register.setFont(font)
        self.btn_register.setCursor(QtGui.QCursor(QtCore.Qt.OpenHandCursor))
        self.btn_register.setStyleSheet("#label_pwd\n"
"{\n"
...
"}")
    ...
    def retranslateUi(self, Widget):
        ...
        Widget.setWindowTitle(_translate("Widget", "注册空教室查询系统"))
        self.label_login.setText(_translate("Widget", "BUPT"))
        self.btn_Return.setText(_translate("Widget", "   Return   "))
        self.btn_register.setText(_translate("Widget", "Register"))
