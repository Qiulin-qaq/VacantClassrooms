...
class logInWidget(QWidget):
    ...
    def login_verify(self):
        ...
        if result:
            ...
            # 设置对话框的几何属性
            lofIn_succeed_message_box.setGeometry(center_x - lofIn_succeed_message_box.width() // 2, center_y - lofIn_succeed_message_box.height() // 2, 300, 300)  # 设置对话框的位置和大小
            ...
            # 设置对话框的几何属性
            login_failed_message_box.setGeometry(center_x - login_failed_message_box.width() // 2, center_y - login_failed_message_box.height() // 2, 300, 300)  # 设置对话框的位置和大小
    ...
    def register_user(self):
        ...
        if username and password:  # 简单的验证
            try:
                ...
                # 设置对话框的几何属性
                register_succeed_message_box.setGeometry(center_x - register_succeed_message_box.width() // 2, center_y - register_succeed_message_box.height() // 2, 300, 300)  # 设置对话框的位置和大小
                ...
                # 设置对话框的几何属性
                registe_failed_message_box.setGeometry(center_x - registe_failed_message_box.width() // 2, center_y - registe_failed_message_box.height() // 2, 300, 300)  # 设置对话框的位置和大小
            ...
            # 设置对话框的几何属性
            reister_failed_message_box.setGeometry(center_x - reister_failed_message_box.width() // 2, center_y - reister_failed_message_box.height() // 2, 300, 300)  # 设置对话框的位置和大小
...
class mainWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.time_Buttons=[self.time1_QPushButton, self.time2_QPushButton, self.time3_QPushButton, self.time4_QPushButton,
                        self.time5_QPushButton, self.time6_QPushButton, self.time7_QPushButton, self.time8_QPushButton,
                        self.time9_QPushButton, self.time10_QPushButton, self.time11_QPushButton, self.time12_QPushButton,
                        self.time13_QPushButton, self.time14_QPushButton]
        self.time_Enable_Buttons=[self.time1_QPushButton, self.time2_QPushButton, self.time3_QPushButton, self.time4_QPushButton,
                        self.time5_QPushButton, self.time6_QPushButton, self.time7_QPushButton, self.time8_QPushButton,
                        self.time9_QPushButton, self.time10_QPushButton, self.time11_QPushButton, self.time12_QPushButton,
                        self.time13_QPushButton, self.time14_QPushButton]
        ...
        for button in self.time_Buttons:
            ...
            if self.current_time.hour > hour.hour or (self.current_time.hour == hour.hour and self.current_time.minute > hour.minute):
    ...
    def check_builidng_all(self):
         if ((self.building1_QPushButton.isChecked()==True) and (self.building2_QPushButton.isChecked()==True)
                 and (self.building3_QPushButton.isChecked()==True) and (self.building4_QPushButton.isChecked()==True)):
